...
import gym
# The functions needed from these modules are now deprecated, this code will NOT work
...
doom_env = image_preprocessing.PreprocessImage(SkipWrapper(4)(ToDiscrete("minimal")(
    gym.make("ppaquette/DoomCorridor-v0"))), width=80, height=80, grayscale=True)
...
softmax_body = SoftmaxBody(Temperature=1)
...
# Implemmenting Eligibility Trace
